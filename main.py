...
def load_data(
    ...
    full_xs = np.load(os.path.join(loc, combined_nm))
    full_ys = np.load(os.path.join(loc, segmented_nm))
...
if __name__ == "__main__":
    ...
    # Consider NumpyArrayIterator - actually looks like it's being used behind scenes
    ...
    model.fit(
        ...
        steps_per_epoch= train_samples * trn_split // train_batch_size,
        validation_data=validation_generator,
        validation_batch_size=val_batch_size,
        validation_steps= train_samples * val_split // val_batch_size,
        epochs=100,
        callbacks=callbacks,
